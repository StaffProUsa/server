...
public class StaffTipoCompany {
    public static final String COMPONENT = "staff_tipo_company";
    ...
    public static void getAll(JSONObject obj, SSSessionAbstract session) {
        try {
            ...
            String consulta = "select get_all('" + COMPONENT + "', 'key_company', '" + obj.get("key_company") + "') as json";
